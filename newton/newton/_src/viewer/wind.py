...
class Wind:
    """Wind force system for particle simulations with fixed direction."""
    ...
    def __init__(self, model):
        ...
        self._wind_params_host.amplitude = 0.00  # gentle default
        self._wind_params_host.frequency = 0.0
        self._wind_params_host.direction = wp.vec3(1.0, 0.0, 0.0)
        self._wind_params_host.dt = 0.00
    ...
    def update(self, dt):
        ...
        # Push updated params to GPU (same pointer → works with CUDA graph).
    ...
    @property
    def period(self):
        """Wind intensity oscillation period."""
    ...
    @property
    def frequency(self):
        """Wind intensity oscillation frequency."""
